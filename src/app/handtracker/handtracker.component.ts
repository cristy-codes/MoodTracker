    ...
    if (this.model != null) {
      let predictions = this.model.detect(this.video.nativeElement).then(
        (predictions: any) => {
          ...
          // Custom gestures
          if (openhands == 1 && closedhands == 1) this.detectedGesture = "One Open, One Closed Hand";
          if (pointing == 1 && closedhands == 1) this.detectedGesture = "One Pointing, One Closed Hand";
